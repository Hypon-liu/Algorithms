...
import algorithm.leetcode.easy.Solution1TwoSum;
...
public class Solution1TwoSumTest {
    ...
    public void twoSum() throws Exception {
        assertArrayEquals(result,new Solution1TwoSum().twoSum(nums,target));
    }

    @Test
    public void twoSum1() throws Exception {
        assertArrayEquals(result,new Solution1TwoSum().twoSum1(nums,target));
    }

    @Test
    public void twoSum2() throws Exception {
        assertArrayEquals(result,new Solution1TwoSum().twoSum2(nums,target));
    }

    @Test
    public void twoSum3() throws Exception {
        assertArrayEquals(result,new Solution1TwoSum().twoSum3(nums,target));
    }
